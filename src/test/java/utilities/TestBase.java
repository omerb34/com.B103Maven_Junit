...
//---------------------------------------------------------------------------------------------------------------------
    ...
    //    MULTIPLE WINDOW:
//    1 parametre alir : Bu title Gecis Yapmak Istedigim sayfanin Titledır.
//    ORNEK:
...
//    switchToWindow("The Internet")
    ...
    //birden çok açılan pencere için aşağıda bir method yapacağız. pencereler arasına bu method ile geciş yapacağız
    //(pencerelerin indexi 0 dan başlar bunu unutmamak lazım)
...
//        path
    ...
    //    SCROLLINTOVIEWJS
    //parametre: webwlelement
    //verilen weblelentin üzerine kaydırma yapar.
