...
//        Given kullanici https://testcenter.techproeducation.com/index.php?page=dropdown sayfasindayken
    ...
    public void selectFromDropdown(WebElement dropdown, String secenek){// yıl elementini bul, string ile günü yaz dedik
...
//        Gonderilen dropdown elemention tum optionslari alinir
    ...
    public void selectFromDropdown(){
        ...
        selectFromDropdown(driver.findElement(By.id("state")),"Texas");// baska örnek texsası sectik.
