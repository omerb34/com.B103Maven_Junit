...
public class P08_Cookies extends TestBase {
/*
                                    Cookies(Çerezler)
    ...
    public void test01() throws InterruptedException {
        ...
        System.out.println("cookie sayısı" + cookies.size());
        ...
        //Yeni cookie eklendikten sonra cookie sayısını yazdır..
        Set<Cookie> cookies2= driver.manage().getCookies();
        System.out.println("cookie sayısı" + cookies2.size());

        // Yeni cookie eklendikten sonra  isimlerini yazdırınız
